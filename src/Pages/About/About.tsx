    ...
    return (
        <>
            <main className="flex flex-row w-[90%] gap-5 h-full flex-wrap justify-center m-auto">
                ...
                <article className="w-full sm:w-[430px] bg-[#EAE8E1] p-5 shadow-md flex flex-col text-center">
                    <section className="lg:mt-10">
                        <h2 className="text-2xl text-[#2F4B41] mb-2">Vår affärsidé</h2>
                        ...
                        <h2 className="text-2xl text-[#2F4B41] mb-2 mt-2">Vår vision</h2>
                        <p className="text-[#373F47] text-sm">Vi skapar och tillför värden i människors utomhusmiljö.</p>
                        <h2 className="text-2xl text-[#2F4B41] mb-2 mt-2">Våra värderingar</h2>
                        <p className="text-[#373F47] text-sm">Glädje, energi, nyfikenhet och vi drivs av goda resultat.</p>
                    </section>
                    <img src={about} alt="Micke och Jessica" className="mt-3 rounded-b-sm shadow-md m-auto mb-0" loading="lazy" />
                    <p className="text-xs italic tracking-wide text-[#2F4B41] mt-1">Kreativa krafter, Micke och Jessica</p>
                </article>
                ...
                <article className="flex-1 flex flex-col gap-5 text-center m-auto">
                    ...
                    <section className="relative p-6 shadow-md lg:w-2/4 m-auto">
                        ...
                        <div className="relative w-full sm:w-1/2 p-6 shadow-md flex rounded-lg lg:w-1/3">
                            ...
                            <div className="relative z-10 px-5 flex flex-col items-center text-center mt-auto mb-auto text-[#2F4B41]">
                                ...
                                <p className="text-sm">
                                    ...
                                    Som kompensation planterar vi träd via <a href="https://www.viskogen.se" className="text-emerald-600 underline" target="_blank" aria-label="Läs mer om vårt samarbete med VI-skogen och trädplantering">VI-skogen</a> och klimatkompenserar för ca 3 ton CO₂/år.
                                </p>
                                <img src={tree} alt="VI-skogen" className="m-auto mt-2 max-w-xs" loading="lazy" />
                            </div>
                        </div>
                    </section>
